...
## Преобразование из не нормальной формы

Также Петрович способен с достаточно высокой по ощущениям точностью
преобразовывать к нормальной форме, а именно в именительный падеж, имена,
отчества, и фамилии, заданные в не нормальной формы, или иначе, в
не именительном падеже.

Делается оное добавлением 3-го аргумента, задающего исходный падеж, и установкою
2-го аргумента в значение :nominative, в частости так:
...
Также Петрович позволяет преобразовывать сразу в любой, отличный от
именительного, падеж, так:
